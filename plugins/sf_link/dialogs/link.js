...
CKEDITOR.dialog.add( 'sf_link', function( editor )
{
	var plugin = CKEDITOR.plugins.sf_link;
							...
							jQuery.getJSON( "action/article/ckeditor/links", function( data ){
								if( data.success ){
									for( var i = 0; i < data.links.length; i++ ){
										...
										var option = "<option value='" + link.value + "'>" + link.label + "</option>";
										selectEle.appendHtml( option );
									}
								} else {
