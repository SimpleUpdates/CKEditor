...
CKEDITOR.plugins.add( 'sf_link',
{
	init : function( editor )
	{
		// Add the link and unlink buttons.
		var pluginName = "sf_link";
		editor.addCommand( pluginName, new CKEDITOR.dialogCommand( pluginName ) );
		editor.addCommand( 'anchor', new CKEDITOR.dialogCommand( 'anchor' ) );
		editor.addCommand( 'unlink', new CKEDITOR.unlinkCommand() );
		editor.ui.addButton( 'SFLink',
			{
		...
		editor.on( 'doubleclick', function( evt )
			{
				var element = CKEDITOR.plugins.sf_link.getSelectedLink( editor ) || evt.data.element;
			...
			editor.contextMenu.addListener( function( element, selection )
				{
					...
					if ( !isAnchor )
					{
						if ( !( element = CKEDITOR.plugins.sf_link.getSelectedLink( editor ) ) )
							return null;
...
CKEDITOR.plugins.sf_link =
{
	/**
	 *  Get the surrounding link element of current selection.
	 * @param editor
	 * @example CKEDITOR.plugins.sf_link.getSelectedLink( editor );
	 * @since 3.2.1
